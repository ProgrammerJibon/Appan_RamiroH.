...
public class CartAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (!cartDTOList.get(position).getSize().equals("") && !cartDTOList.get(position).getSize().equalsIgnoreCase("0")) {
        ...
        mViewHolder.ctvbPrice1.setText(cartDTOList.get(position).getCurrency_type() + " " + ProjectUtils.round(cartDTOList.get(position).getMrp(), 2) + ""); //pehle .getp_rate() lga hua tha pehle
