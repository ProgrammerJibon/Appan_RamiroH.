...
import com.yapue.appan.databinding.AdapterProductsForAnimBinding;
...
public class AdapterProductsForAnim extends RecyclerView.Adapter<AdapterProductsForAnim.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        if (!productsForAnimArrayList.get(i).getDiscount().equals("0")) {
                myViewHolder.binding.ctvbOld.setText(productsForAnimArrayList.get(i).getCurrency_type() + " " + ProjectUtils.round(productsForAnimArrayList.get(i).getP_rate(), 2) + "");
