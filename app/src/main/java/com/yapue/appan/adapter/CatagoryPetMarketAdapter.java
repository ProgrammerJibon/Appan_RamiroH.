...
import com.yapue.appan.activity.petmarket.ShowPetMarketActivity;
...
public class CatagoryPetMarketAdapter extends RecyclerView.Adapter<CatagoryPetMarketAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        Glide.with(context).load(petCatList.get(position).getPet_image()).placeholder(R.drawable.app_logo).into(holder.ivType);
