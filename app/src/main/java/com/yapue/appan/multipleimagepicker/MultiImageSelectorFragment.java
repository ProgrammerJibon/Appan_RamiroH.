...
import com.yapue.appan.activity.AddMemories;
import com.yapue.appan.multipleimagepicker.adapters.FolderAdapter;
import com.yapue.appan.multipleimagepicker.adapters.ImageGridAdapter;
import com.yapue.appan.multipleimagepicker.listeners.FolderOnItemClickListener;
import com.yapue.appan.multipleimagepicker.listeners.ImageOnItemClickListener;
import com.yapue.appan.multipleimagepicker.models.Folder;
import com.yapue.appan.multipleimagepicker.models.Image;
import com.yapue.appan.multipleimagepicker.utils.FileUtils;
import com.yapue.appan.multipleimagepicker.utils.ScreenUtils;
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        imgPathUri = FileProvider.getUriForFile(getActivity(), BuildConfig.APPLICATION_ID + ".fileprovider",mTmpFile);
